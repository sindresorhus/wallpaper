...
function setAvailableApps() {
	...
	return exec(whichCmd).then(function (stdout) {
		if (!stdout) {
...
exports.get = function get() {
	...
	const app = availableApps.find(app => app.get !== undefined);

	return execFile(app.cmd, app.get).then(stdout => {
...
exports.set = function set(imagePath) {
	...
	const app = availableApps.find(app => return app.set !== undefined);
